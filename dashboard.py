...
cd ~/Nextcloud/Projects/AthleteComparison/Soccer && source ~/.venvs/athlete-soccer/bin/activate && streamlit run dashboard.py
...
from config_loader import config, get_absolute_path

# =============================================================================
#                          CONFIG
# =============================================================================

DB_PATH = str(get_absolute_path(config.paths.analysis_db))
PROFILES_DB_PATH = str(get_absolute_path(config.paths.profiles_db))
